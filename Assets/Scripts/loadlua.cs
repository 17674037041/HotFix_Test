...
public class loadlua : MonoBehaviour
{
    ...
    {
        luaEnv = new LuaEnv();
        hotfixBtn = transform.Find("fixButton").GetComponent<Button>();
    ...
    {
        Debug.Log("开始下载");
        UnityWebRequest request = UnityWebRequestAssetBundle.GetAssetBundle(@"Http://localhost/AssetsBundle/luascript.assetsbundle");
